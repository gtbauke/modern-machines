...
public class SizedBox extends UiWidget {
    ...
    public SizedBox(int width, int height, UiWidget child) {
    ...
    public static SizedBox of(int width, int height) {
        return new SizedBox(width, height);
    }

    public static SizedBox of(int width, int height, UiWidget child) {
        return new SizedBox(width, height, child);
    }

    public static SizedBox horizontal(int width) {
        return new SizedBox(width, 0);
    }

    public static SizedBox vertical(int height) {
        return new SizedBox(0, height);
    }

    public static SizedBox w(int width) {
        return new SizedBox(width, 0);
    }

    public static SizedBox h(int height) {
        return new SizedBox(0, height);
    }

    public static SizedBox square(int size) {
