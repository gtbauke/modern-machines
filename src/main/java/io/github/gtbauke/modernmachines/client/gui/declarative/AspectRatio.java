...
public class AspectRatio extends UiWidget {
    private final UiWidget child;

    public AspectRatio(float aspectRatio, UiWidget child) {
        this.flexNode.setAspectRatio(aspectRatio);
        this.child = child;
        if (child != null) {
    ...
    public static AspectRatio of(float aspectRatio, UiWidget child) {
        return new AspectRatio(aspectRatio, child);
    }
